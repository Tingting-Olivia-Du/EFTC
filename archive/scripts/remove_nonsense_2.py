...
corpus_file = "F:/research_file/FAWL_Python/corpus/test_corpus/merged_corpus_test.json"  # Update with your actual file path
...
output_file = "F:/research_file/FAWL_Python/corpus/test_corpus/corpus_list_test.json"  # Specify the output file path
